...
export default function KathaArchive({
	...
	return (
        ...
        .archive-apply{width:100%;height:44px;margin-top:19px;border-radius:6px;background:var(--archive-accent);color:#fff;font-size:13px;font-weight:700}
        ...
        @media(max-width:820px){.archive-hero{min-height:310px}.archive-hero-shade{background:linear-gradient(90deg,rgba(251,250,247,.98),rgba(251,250,247,.78))}.archive-layout{grid-template-columns:1fr;margin-top:16px}.archive-filters{order:0}.archive-filters form{display:grid;grid-template-columns:1fr 1fr;gap:12px}.archive-filters fieldset{grid-column:1/-1}.archive-apply{align-self:end}.archive-grid{grid-template-columns:repeat(2,1fr)}}
