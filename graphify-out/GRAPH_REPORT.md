...
## Corpus Check
- 201 files · ~557,639 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 615 nodes · 853 edges · 22 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 306 edges (avg confidence: 0.8)
...
Cohesion: 0.05
Nodes (50): sitemap(), PUT(), GET(), POST(), GET(), POST(), PUT(), DELETE() (+42 more)
...
Cohesion: 0.23
Nodes (5): assignToNitnem(), handleCreateKatha(), loadEntries(), removeEntry(), toggleExpand()
...
- **Why does `connectDB()` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 14`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `generateSlug()` connect `Community 3` to `Community 0`, `Community 2`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `requireAdmin()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Are the 93 inferred relationships involving `connectDB()` (e.g. with `sitemap()` and `HomePage()`) actually correct?**
  _`connectDB()` has 93 INFERRED edges - model-reasoned connections that need verification._
